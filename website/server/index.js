  ...
  <header class="site-header" data-site-header>
    ...
    <div class="navigation-panel" id="site-navigation" data-navigation-panel>
      ...
      <div class="header-actions">
        <button class="theme-toggle" type="button" data-theme-toggle aria-label="${language === "hu" ? "Világos/sötét téma" : "Light/dark theme"}" title="${language === "hu" ? "Világos/sötét téma" : "Light/dark theme"}"><span class="theme-toggle__icon" data-theme-icon aria-hidden="true"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="3.6"/><path d="M12 2.2v2.1M12 19.7v2.1M4.9 4.9l1.5 1.5M17.6 17.6l1.5 1.5M2.2 12h2.1M19.7 12h2.1M4.9 19.1l1.5-1.5M17.6 6.4l1.5-1.5"/></svg></span></button>
